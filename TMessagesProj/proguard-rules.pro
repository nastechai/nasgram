...
-keepclassmembernames,allowshrinking class tw.nekomimi.nasgram.MessageDetailsActivity$TextDetailSimpleCell { <fields>; }
-keepclassmembernames,allowshrinking class tw.nekomimi.nasgram.settings.AccountCell { <fields>; }
-keepclassmembernames,allowshrinking class tw.nekomimi.nasgram.settings.EmojiSetCell { <fields>; }
-keepclassmembernames,allowshrinking class tw.nekomimi.nasgram.settings.NekoChatSettingsActivity$StickerSizeCell { <fields>; }

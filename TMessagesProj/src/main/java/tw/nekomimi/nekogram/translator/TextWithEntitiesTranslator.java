...
import app.nasgram.translator.BaiduTranslator;
import app.nasgram.translator.BaseTranslator;
import app.nasgram.translator.DeepLTranslator;
import app.nasgram.translator.GoogleAppTranslator;
import app.nasgram.translator.LingoTranslator;
import app.nasgram.translator.MicrosoftTranslator;
import app.nasgram.translator.SogouTranslator;
import app.nasgram.translator.TranSmartTranslator;
import app.nasgram.translator.YandexTranslator;
import app.nasgram.translator.YouDaoTranslator;
import tw.nekomimi.nasgram.NekoConfig;
import tw.nekomimi.nasgram.translator.html.HTMLKeeper;

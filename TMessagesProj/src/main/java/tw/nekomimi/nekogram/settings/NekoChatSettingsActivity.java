...
import tw.nekomimi.nasgram.helpers.EntitiesHelper;
import tw.nekomimi.nasgram.helpers.PopupHelper;
import tw.nekomimi.nasgram.helpers.VoiceEnhancementsHelper;
import tw.nekomimi.nasgram.helpers.WhisperHelper;
...
public class NekoChatSettingsActivity extends BaseNekoSettingsActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(TextSettingsCellFactory.of(markdownParserRow, LocaleController.getString(R.string.MarkdownParser), NekoConfig.newMarkdownParser ? "nasgram" : "Telegram").slug("markdownParser"));
